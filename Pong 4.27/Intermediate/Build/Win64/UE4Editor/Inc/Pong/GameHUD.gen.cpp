...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameHUD_UpdateAIScore_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameHUD, nullptr, "UpdateAIScore", nullptr, nullptr, sizeof(GameHUD_eventUpdateAIScore_Parms), Z_Construct_UFunction_UGameHUD_UpdateAIScore_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameHUD_UpdateAIScore_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameHUD_UpdateAIScore_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameHUD_UpdateAIScore_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameHUD_UpdatePlayerScore_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameHUD, nullptr, "UpdatePlayerScore", nullptr, nullptr, sizeof(GameHUD_eventUpdatePlayerScore_Parms), Z_Construct_UFunction_UGameHUD_UpdatePlayerScore_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameHUD_UpdatePlayerScore_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameHUD_UpdatePlayerScore_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameHUD_UpdatePlayerScore_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameHUD_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameHUD_UpdateAIScore, "UpdateAIScore" }, // 1381167384
		{ &Z_Construct_UFunction_UGameHUD_UpdatePlayerScore, "UpdatePlayerScore" }, // 3058074458
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGameHUD, 1879298704);
